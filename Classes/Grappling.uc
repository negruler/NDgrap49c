class Grappling extends TournamentWeapon;

#exec AUDIO IMPORT FILE="Sounds\Pull.wav" NAME="Pull"
#exec AUDIO IMPORT FILE="Sounds\reset.wav" NAME="Reset"
        ...
        if (GrapHook.IsInState('Hooked'))
        {
            ...
            if(GrapHook!=none && Owner!=none){
                ...
                { 
                    ...
                    PlayerPawn(Owner).ReceiveLocalizedMessage(class'NDgrap49c.Msg');
                    else
                    PlayerPawn(Owner).ReceiveLocalizedMessage(class'NDgrap49c.FlagMsg');
                    bPast90=true; 
                }
            }
